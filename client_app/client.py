...
def post_method(server_port):
    with grpc.insecure_channel(server_port) as channel:
        stub = user_pb2_grpc.UserServiceStub(channel)
        name = str(input('enter your name:'))
        response = stub.append(user_pb2.UserPostRequest(name=name))
...
# servers_ports = ["50051", "50052", "50053"]
servers_ports = ["localhost:50051", "localhost:50052", "localhost:50053"]
...
def run():
    ...
    if method_key == '1':
        post_method(servers_ports[0]), run()
